...
/*  function getMessage(uuid,email) {
   const body = `Your password is ${uuid}! Enjoy the experiment!`;
   return {
     to: email,
     from: 'haoluntutu@gmail.com',
     subject: 'Welcome to EE701',
     text: body,
    //  html: `<strong>${body}</strong>`,
     html: `<strong>${body}</strong>
     <img src="https://www.rd.com/wp-content/uploads/2021/04/GettyImages-468779450-e1618492835602.jpg?w=1776">`,
 ...
 function getMessage(uuid, email) {
  const body = `Your password is ${uuid}\nEnjoy the experiment!`;
  return {
    to: email,
    from: 'haoluntutu@gmail.com',
    subject: 'Welcome to EE701',
    text: body,
    html: `
    <p style="font-size: 40px; font-weight: bold;">Your password is ${uuid}</p>
    <p style="font-size: 40px; font-weight: bold;">Enjoy the experiment!</p>
    `,
  };
}

/* <img src="https://www.rd.com/wp-content/uploads/2021/04/GettyImages-468779450-e1618492835602.jpg?w=1776" alt="Image">  */
